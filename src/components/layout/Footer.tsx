        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Contemporary artist exploring the intersection of nature and human emotion 
              through vibrant colors and organic forms.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/gift-cards" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Gift Cards
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/forum" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Forum
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/stories" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Artist Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/copyright" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Copyright
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/newsletter" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Newsletter
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <a href={`mailto:${sampleArtist.contact.email}`} className="text-gray-300 hover:text-white text-sm">
                  {sampleArtist.contact.email}
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-gray-400" />
                <a href={`tel:${sampleArtist.contact.phone}`} className="text-gray-300 hover:text-white text-sm">
                  {sampleArtist.contact.phone}
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin className="h-4 w-4 text-gray-400" />
                <span className="text-gray-300 text-sm">{sampleArtist.contact.location}</span>
              </div>
            </div>
            <div className="flex items-center space-x-6">
              ...
              <Link href="/sitemap" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">
                Sitemap
              </Link>
            </div>
          </div>
