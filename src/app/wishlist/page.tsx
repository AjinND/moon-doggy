      ...
      <div className="pt-16 min-h-screen bg-gradient-to-br from-gray-50 via-white to-purple-50/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto">
            Start building your collection by adding artworks you love to your wishlist.
          </p>
          ...
          <div className="flex items-center mb-4 sm:mb-0">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                {wishlist.length} artwork{wishlist.length !== 1 ? 's' : ''} saved
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex border border-gray-300 rounded-lg overflow-hidden">
              <button
                ...
                className={`p-2 transition-colors touch-button ${viewMode === 'grid' ? 'bg-purple-100 text-purple-600' : 'text-gray-600 hover:bg-gray-50'}`}
              ...
              <button
                ...
                className={`p-2 transition-colors touch-button ${viewMode === 'list' ? 'bg-purple-100 text-purple-600' : 'text-gray-600 hover:bg-gray-50'}`}
